...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            ...
            <button type="button" class="btn btn-primary btn-sm" onclick="window.location.href='/user'">Dashboard</button>
                ...
                <div class="card-body p-4 d-flex flex-column flex-md-row align-items-start">
                    ...
                    <div class="mt-2 mt-md-0 ml-md-auto">
                        <div class="justify-content-end gap-2">
                            <a href="/damaedit/{{ $item->id }}" class="btn btn-primary btn-sm mt-2">Edit</a>
                            @if (Auth::user()->role === 'admin')
